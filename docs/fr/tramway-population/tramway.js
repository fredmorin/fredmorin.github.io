...
var quebecExtent =  [-7966369.003918784, 5887934.621700673, -7900327.411480391, 5931350.853766653];
...
var trajet = new ol.layer.Vector({
  source: new ol.source.Vector({
    url: '/geojson/tramway/tramway-trajet.json',
    format: new ol.format.GeoJSON() 
  }),
  style: trajetStyle,
  extent: quebecExtent
...
var stations = new ol.layer.Vector({
  source: new ol.source.Vector({
    url: '/geojson/tramway/tramway-stations.json',
    format: new ol.format.GeoJSON() 
  }),
